...
const Course = ({course}) => {
    ...
    return (
     ...
     <div class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-white dark:border-gray-700">
        ...
        <img class="p-8 rounded-t-lg" src={course.img} alt="product image" />
 
    <div class="px-5 pb-5">
     
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-gray-900">{course.name}</h5>
